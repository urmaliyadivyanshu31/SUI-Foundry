...
import { suiDentityContracts, type UpgradeTicketData, type ReputationCardData } from '@/lib/blockchain/smart-contracts'
import { useErrorHandler } from '@/components/error-boundary'
import { AppError, BlockchainError } from '@/lib/core/error-handler'
import { 
  Ticket, 
  Gift, 
  Star, 
