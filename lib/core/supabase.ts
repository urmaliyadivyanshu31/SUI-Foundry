...
export const supabase = (() => {
  if (typeof window !== 'undefined') {
    // Browser environment - use singleton browser client
    if (!clientInstance) {
      clientInstance = createBrowserClient<Database>(defaultUrl, defaultAnonKey)
    }
    return clientInstance
  } else {
    // Server environment - create new client
    return createClient<Database>(defaultUrl, defaultAnonKey)
  }
})()
